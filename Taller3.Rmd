...
# Punto 12: Inclusión de variable de bloque localidades.
...
El modelo indica que hay diferencias entre los grupos, lo cual también se evidencio en los análisis previos, es decir que la inclusión de esta variable no cambia de forma significativa las conclusiones realizadas previamente.
