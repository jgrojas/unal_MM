...
Para evaluar la igualdad de la matriz de varianza y covarianza fue realizado el test de *Box*
...
Se realizó un gráfico box-plot para cada uno de los valores de longitud de onda y también fue realizada la prueba de *Dixon* que también hace la identificación de los valores atípicos:
