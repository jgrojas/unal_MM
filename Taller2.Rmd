...
A pesar de que es m?s exigente por correcci?n de Bonferroni (nivel de confianza de 97.5%), aún no se puede rechazar las hípotesis nulas debido a que los p-valor de las pruebas son mayores a 0.10, es decir mucho más que el nivel de significancia.
...
d. Estime el error est?ndar para la diferencia de medias  por método Bootstrap para ajustar la prueba t con este error y compare con el resultado sin el método Bootstrap.
